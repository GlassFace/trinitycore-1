...
UPDATE `locales_creature` SET `name_loc1` = REPLACE(`name_loc1`, "[4.x ???]", "");
UPDATE `locales_creature` SET `name_loc1` = REPLACE(`name_loc1`, "[4.x ??] ", "");
UPDATE `locales_creature` SET `name_loc1` = REPLACE(`name_loc1`, " (4.x ???)", "");
...
UPDATE `locales_creature` SET `name_loc2` = REPLACE(`name_loc2`, "[DEPRECATED 4.x]", "");
UPDATE `locales_creature` SET `name_loc2` = REPLACE(`name_loc2`, "[DEPRECATED 4.0]", "");
UPDATE `locales_creature` SET `name_loc2` = REPLACE(`name_loc2`, "[INUTILIS¨¦ 4.x] ", "");
UPDATE `locales_creature` SET `name_loc2` = REPLACE(`name_loc2`, "[Inutilis¨¦ pour 4.x] ", "");
UPDATE `locales_creature` SET `name_loc2` = REPLACE(`name_loc2`, "[INUTILIS¨¦ pour 4.x] ", "");
...
UPDATE `locales_creature` SET `name_loc3` = REPLACE(`name_loc3`, "[INUTILIS¨¦ 4.x] ", "");
UPDATE `locales_creature` SET `name_loc3` = REPLACE(`name_loc3`, "[Inutilis¨¦ pour 4.x] ", "");
